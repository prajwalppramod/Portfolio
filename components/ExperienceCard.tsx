...
function ExperienceCard({ experience }: ExperienceCardProps) {
  ...
  return (
    <div>
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[350px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 md:hover:opacity-100 opacity-80 cursor-pointer transition-opacity duration-200 overflow-hidden">
        <motion.img
        ...
        <div className="px-0 md:px-10">
          ...
          <p className="font-bold text-lg md:text-2xl mt-2">{companyname}</p>
